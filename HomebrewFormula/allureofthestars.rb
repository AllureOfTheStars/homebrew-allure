...
class AllureOfTheStars < Formula
  ...
  test do
    system "#{bin}/Allure", "--dbgMsgSer", "--logPriority 0", "--newGame 3", "--maxFps 100000", "--benchmark", "--stopAfterFrames 50", "--automateAll", "--keepAutomated", "--gameMode battle", "--setDungeonRng 7", "--setMainRng 7"
  end
end
